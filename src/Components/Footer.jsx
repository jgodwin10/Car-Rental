      ...
      <div className="grid grid-cols-1 text-center sm:text-left lg:grid-cols-4 max-w-[1340px] mx-auto pb-40 px-8 sm:grid-cols-2">
        ...
        <div className="mt-24 sm:ml-12">
          ...
          <form className="mt-4 flex flex-col" action="">
            <input
              className="outline-none bg-gray-200 px-12 text-[13px] py-[12px]"
              type="email"
              placeholder="Enter Email Address"
            />
            <button className="px-12 py-[12px] text-white text-[15px] font-bold bg-[#fe4d30] hover:text-[#fe4d30] transition duration-[0.5s] hover:bg-white hover:border hover:border-[#fe4d30] mt-2">
              Submit
            </button>
          </form>
        </div>

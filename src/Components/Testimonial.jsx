...
const Testimonial = () => {
  return (
    <div className="text-center max-w-[1100px] mx-auto px-8 py-28">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-8 mt-16 w-[90%] md:w-[80%] mx-auto lg:w-auto">

      <div
      
      className="bg-[rgb(255,255,255)] shadow-lg rounded-md col-span-1">
        ...
        <div className="flex justify-start items-center p-8 pb-12">
          <img width={70} className="rounded-full" src="src/images/testimonials/pfp1.jpg" alt="" />
      ...
      <div className="bg-white shadow-lg rounded-md ">
        ...
        <div className="flex justify-start items-center p-8 pb-12">
          <img width={60} className="rounded-full" src="src/images/testimonials/pfp2.jpg" alt="" />
          <div className="text-left pl-4">
